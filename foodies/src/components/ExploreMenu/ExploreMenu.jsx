...
const ExploreMenu = ({category, setCategory}) => {
    ...
    return (
        <div className="explore-menu position-relative">
            ...
            <p>Explore curated lists of dishes form top categories</p>
            <div className="d-flex justify-content-between gap-4 overflow-auto explore-menu-list" ref={menuRef}>
                {
                    categories.map((item, i) => {
                        return (
                            <div key={i} className="text-center explore-menu-list-item" onClick={() => setCategory(prev => prev === item.category ? 'All' : item.category)}>
